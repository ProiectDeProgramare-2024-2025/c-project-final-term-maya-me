...
void add_playlist(playlist* playlists) {
    ...
    read(playlists, &number_of_playlists, "fisier.txt");
    ...
    write(playlists, number_of_playlists, "fisier.txt");
...
int main(int argc, char *argv[]) {
    printf(WHITE);
    if (argc == 2 && strcmp(argv[1], "vizualizare") == 0) {
        ...
        playlist new_playlist;
    } else if (argc == 2 && strcmp(argv[1], "adaugare_playlist") == 0) {
        playlist playlists[10];
        add_playlist(playlists);
    } else if (argc == 2 && strcmp(argv[1], "adaugare_cantec") == 0) {
        playlist playlists[10];
        add_song(playlists);
    }  else if (argc == 2 && strcmp(argv[1], "stergere_playlist") == 0) {
        playlist playlists[10];
        delete_playlist(playlists);
    }  else if (argc == 2 && strcmp(argv[1], "stergere_cantec") == 0) {
        playlist playlists[10];
        delete_song(playlists);
    }  else if (argc == 2 && strcmp(argv[1], "help") == 0) {
        printf("%svizualizare%s: afiseaza playlisturile tale\n", RED, WHITE);
        printf("%sadaugare_playlist%s: adauga un playlist\n", RED, WHITE);
        printf("%sadaugare_cantec%s: adauga un cantec\n", RED, WHITE);
        printf("%sstergere_playlist%s: sterge un playlist\n", RED, WHITE);
        printf("%sstergere_cantec%s: sterge un cantec\n", RED, WHITE);
    } else{
        printf("%sComanda inexistenta%s\n", RED, WHITE);
    }
}